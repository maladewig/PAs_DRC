...
<qgis version="3.28.15-Firenze">
  <identifier>pays</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Country</title>
  <abstract>This theme indicates the geographical limits of the Democratic Republic of Congo. This data was produced using official data on a 1: 200,000 scale topographic map. The data were produced by the Working Group. This layer represents an overview of the provinces and Does not correspond to the official limits. There is no legal process for validating these data. 

Country's bounderies</abstract>
  <keywords vocabulary="Search keys">
    <keyword>GFW</keyword>
    <keyword> Atlas</keyword>
    <keyword> MECNDD</keyword>
    <keyword> congo</keyword>
  </keywords>
  <links/>
  <history>Data source: This dataset is produced by INC. Data comes from a variety of sources including documents, official maps, topographic maps and scanned maps.</history>
  <fees></fees>
  <constraints type="Limitations of use">The accuracy of the data depends on the source.</constraints>
  <rights>This dataset is produced by the National Institute of Cartography.</rights>
  <encoding></encoding>
  <crs>
  ...
  <extent>
    <spatial maxy="0" minz="0" maxx="0" miny="0" maxz="0" dimensions="2" minx="0" crs="EPSG:3857"/>
  </extent>
</qgis>
